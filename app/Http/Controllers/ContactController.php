...
class ContactController extends Controller
{
    ...
    // Helper methods
    protected function validateContact(Request $request, $ignoreId = null)
    {
        $rules = [
    ...
    protected function saveCustomFields(Contact $contact, Request $request)
    {
        $customFields = CustomField::all();
    ...
    protected function performMerge(Contact $master, Contact $secondary)
    {
        $mergedData = [];
